...
export const searchItems = (keyword)=> async (dispatch)=>{
    ...
    await axios.get(`${process.env.REACT_APP_API_URL}product/find?search=${keyword}`,config).then((res)=>{
        dispatch({
            type: SEARCH_ITEMS,
            payload: res.data
        })
...
export const getProductImages = (id)=> async (dispatch)=>{
    ...
    await axios.get(`${process.env.REACT_APP_API_URL}productImg/${id}/`,config).then((res)=>{
        dispatch({
...
export const getItemByCategory = (category)=> async (dispatch)=>{
    ...
    await axios.get(`${process.env.REACT_APP_API_URL}product/find/${category}/`,config).then((res)=>{
        dispatch({
...
export const addItem = (item,file)=> async (dispatch)=>{
    ...
    if(!file){
        ...
        await axios.post(`${process.env.REACT_APP_API_URL}product/`,item,config).then((res)=>{
            dispatch({
                type: ADD_ITEM,
                payload: res.data
            })
        ...
        await axios.post(`${process.env.REACT_APP_API_URL}uploadFile/`,fileData,config).then(async(res)=>{
...
export const deleteItem = (id, filename)=> async (dispatch)=>{
    ...
    await axios.delete(`${process.env.REACT_APP_API_URL}product/${id}/`,config).then(async(res)=>{

        await axios.get(`${process.env.REACT_APP_API_URL}deleteFile/${filename}/`,config).then((res2)=>{
...
export const updateItem = (id, item, file)=> async (dispatch)=>{
    ...
    if(!file){
        await axios.put(`${process.env.REACT_APP_API_URL}product/${id}/`,item,config).then((res)=>{
            dispatch({
                type: UPDATE_ITEM,
                payload: res.data
            })
        ...
        await axios.post(`${process.env.REACT_APP_API_URL}uploadFile/`,filedata,config).then(async(res)=>{
           if(res.status === 201){
               ...
               await axios.put(`${process.env.REACT_APP_API_URL}product/${id}/`,item,config).then(async(res2)=>{
                await axios.get(`${process.env.REACT_APP_API_URL}deleteFile/${fileNameBefore}/`,config).then((res3)=>{
                    dispatch({
                        type: UPDATE_ITEM,
                        payload: res.data
                    })
